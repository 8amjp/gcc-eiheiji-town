/*
 * Fukui City Garbage and Recycling Collection Calendar.
 *
 * Copyright 2015 8am.
 * http://8am.jp/
 *
 * 永平寺町の次のゴミ収集日を表示するカレンダーです。
 */

$(function() {
    var caption = "Eiheiji Town Garbage and Recycling Collection Calendar.";
    var parent    = "http://8am.jp/%E6%B0%B8%E5%B9%B3%E5%AF%BA%E7%94%BA%E3%81%94%E3%81%BF%E3%82%AB%E3%83%AC%E3%83%B3%E3%83%80%E3%83%BC/";
    var data = {};
    var storagekey = "apps.gcc-eiheiji-town.address";
    ...
    function getData() {
        ...
        $.ajax(
            ...
            {
                dataType: "jsonp",
                jsonpCallback: "eiheizityousyusyubi"
            }
        )
        .done(function( json ) {
            data = json;
